...
select a.code as oldsquad, a.name as oldname, b.code as newsquad, b.name as newname from country a, country b where a.code in (1) and b.code = 1 
union
select a.code as oldsquad, a.name as oldname, a.code as newsquad, a.name as newname from country a where a.code not in (1)