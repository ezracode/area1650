<?php
	...
	function country_stats($country)
	{
		...
		$query = $query . '     on a.newsquad = :country and a.oldsquad = b.squad and b.matchid = h.matchid and b.time_type in (2,3,4,6) and h.game_type between 1 and 24 and h.matchdate < now()';
		$query = $query . ' left join game_score c';
	...
	function match_stats($squada, $squadb)
	{
		...
		$query = $query . ' 	 and b.time_type in (2,3,4,6) and h.game_type between 1 and 24 and h.matchdate < now()';
		$query = $query . ' left join game_score c';
